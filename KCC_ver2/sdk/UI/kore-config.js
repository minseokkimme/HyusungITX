(function(KoreSDK){
    ...
    botOptions.JWTUrl = "http://localhost:3002/api/users/sts";
    botOptions.userIdentity = randNum;// Provide users email id here
    botOptions.botInfo = { name: "KCC_Glass_FAQ_ver2", "_id": "st-8f36dd9b-49f7-5610-a948-9cb91208f17d" }; // bot name is case sensitive
    ...
    **/
    botOptions.clientId = "cs-8a6ad25b-99f8-508d-afe4-39a4bfd1c489";
    botOptions.clientSecret = "fCAtIEuXF+bVV9JpjyIN3HjOfuGg0OxdIXBxLQtG/Xk=";
