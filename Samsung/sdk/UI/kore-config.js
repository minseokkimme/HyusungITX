(function(KoreSDK){
    ...
    botOptions.JWTUrl = "http://61.97.184.107:3003/api/users/sts";
    botOptions.userIdentity = randNum;// Provide users email id here
    botOptions.botInfo = { name: "Samsung_FAQ", "_id": "st-e4682ff0-6930-512c-a42e-6deab08b435a" }; // bot name is case sensitive
    ...
    **/
    botOptions.clientId = "cs-2ea2ddca-f93c-53e5-b6d8-87fcc21455f8";
    botOptions.clientSecret = "eyx514XGK/ePmx9kbEc7Y24gbN611Nn4d/3TEO/EjMY=";
